...
(function() {
    ...
    $.fn.literallybackground = function(background) {
        return this.get(0).literallycanvas.setBackground(background.url);
    };
}).call(this);
    ...
    LC.Toolbar = function() {
        ...
        Toolbar.prototype.initTools = function() {
            ...
            return _.each(this.tools, function(t) {
                ...
                buttonEl = $("        <div class='button tool-" + t.cssSuffix + "' title='" + t.title + "'>          <div class='tool-image-wrapper'></div>        </div>        ");
        ...
        Toolbar.prototype.template = function() {
            return "    <div class='toolbar-row'>      <div class='toolbar-row-left'>        <div class='tools button-group'></div>      </div>      <div class='toolbar-row-right'>        <div class='action-buttons'>          <div class='button clear-button danger' title='Start over'>Clear</div>          <div class='button-group'>            <div class='button btn-warning undo-button' title='Undo'>              <div class='toolbar-image-wrapper'><img src='" + this.opts.imageURLPrefix + "/undo.png'></div>            </div><div class='button btn-warning redo-button' title='Redo'>              <div class='toolbar-image-wrapper'><img src='" + this.opts.imageURLPrefix + "/redo.png'></div>            </div>          </div>          <div class='button-group'>            <div class='button btn-inverse zoom-out-button' title='Zoom out'>              <div class='toolbar-image-wrapper'><img src='" + this.opts.imageURLPrefix + "/zoom-out.png'></div>            </div><div class='button btn-inverse zoom-in-button' title='Zoom in'>              <div class='toolbar-image-wrapper'><img src='" + this.opts.imageURLPrefix + "/zoom-in.png'></div>            </div>          </div>          <div class='zoom-display' title='Current zoomlevel'>1</div>        </div>      </div>      <div class='clearfix'></div>    </div>    <div class='toolbar-row'>      <div class='toolbar-row-left'>        <div class='primary-picker'></div>        <div class='tool-options-container'></div>      </div>      <div class='clearfix'></div>    </div>  ";
        };
        return Toolbar;
    }();
}).call(this);
    ...
    LC.TextTool = function(_super) {
        ...
        TextTool.prototype.begin = function(x, y, lc) {
            ...
            if (!this.endpos) {
                this.input.focus();
                this.size = 16;
                this.currentShape = new LC.Text(x, y, this.size, "sans-serif", lc.getColor("primary"), this.inputText);
                return this.input.on("keyup.edittext change.edittext", function() {
                    return _this["continue"](x, y, lc);
                });
            }
        };
...
(function() {
    ...
    LC.SimpleStrokeWidget = function(_super) {
        ...
        SimpleStrokeWidget.prototype.options = function() {
            ...
            $el = $("      <div class='button-group simple-strokewidth'>        <div class='button' data-strokewidth='2' title='Fine Stroke'>          <div class='tool-image-wrapper'><img src='" + this.opts.imageURLPrefix + "/fine.png'></div>        </div><div class='button' data-strokewidth='5' title='Medium Stroke'>          <div class='tool-image-wrapper'><img src='" + this.opts.imageURLPrefix + "/medium.png'></div>        </div><div class='button' data-strokewidth='20' title='Coarse stroke'>          <div class='tool-image-wrapper'><img src='" + this.opts.imageURLPrefix + "/coarse.png'></div>        </div>      </div>    ");
