            ...
            if (opts === "option" && typeof option === "string") {
                switch (option) {
                  ...
                  case "backgroundImage":
                    ...
                    return el.literallycanvasToolbar.updateZoom();
                }
            }
        });
        return this;
    ...
    LC.Toolbar = function() {
        ...
        Toolbar.prototype.initZoom = function() {
            ...
            this.$el.find(".zoom-in-button").click(function(e) {
                _this.lc.zoom(.2);
                return _this.updateZoom();
            });
            this.$el.find(".zoom-out-button").click(function(e) {
                _this.lc.zoom(-.2);
                return _this.updateZoom();
            });
            return this.$el.find(".zoom-display").click(function(e) {
                _this.lc.zoom(-_this.lc.scale + 1);
                return _this.updateZoom();
            });
        };
        Toolbar.prototype.updateZoom = function() {
            return this.$el.find(".zoom-display").html(this.lc.scale);
        };
