...
(function() {
    ...
    LC.Toolbar = function() {
        ...
        Toolbar.prototype.template = function() {
            return "    <div class='toolbar-row'>      <div class='toolbar-row-left'>        <div class='tools button-group'></div>      </div>      <div class='toolbar-row-right'>        <div class='button clear-button danger varwidth' title='Start over'>Clear</div>        <div class='button-group'>          <div class='button btn-warning undo-button' title='Undo'>            <div class='tool-image-wrapper'><img src='" + this.opts.imageURLPrefix + "/undo.png'></div>          </div><div class='button btn-warning redo-button' title='Redo'>            <div class='tool-image-wrapper'><img src='" + this.opts.imageURLPrefix + "/redo.png'></div>          </div>        </div>        <div class='button-group'>          <div class='button btn-inverse zoom-out-button' title='Zoom out'>            <div class='tool-image-wrapper'><img src='" + this.opts.imageURLPrefix + "/zoom-out.png'></div>          </div><div class='button btn-inverse zoom-in-button' title='Zoom in'>            <div class='tool-image-wrapper'><img src='" + this.opts.imageURLPrefix + "/zoom-in.png'></div>          </div>        </div>        <div class='zoom-display' title='Current zoomlevel'>1</div>      </div>      <div class='clearfix'></div>    </div>    <div class='toolbar-row'>      <div class='toolbar-row-left'>        <div class='primary-picker'></div>        <div class='tool-options-container'></div>      </div>      <div class='clearfix'></div>    </div>  ";
        };
        return Toolbar;
    }();
}).call(this);
